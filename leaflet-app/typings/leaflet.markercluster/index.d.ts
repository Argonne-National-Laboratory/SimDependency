...
declare namespace L {
    ...
    export class MarkerClusterGroup extends FeatureGroup<ILayer> {
        ...
        */
        ...
        /**
         *  Returns list of parents for a given
         *  marker in a cluster
         * (extension provided by leaflet.extendedmarkercluster)
         */
        getParents(marker: Marker): Marker[];

    }

    var MarkerCluster: {
        /**
         * Instantiates a Marker Cluster Object
         * 
         * @constructor
         */
        new (group: MarkerClusterGroup, zoom: Number, a: LatLng, b: LatLng): MarkerCluster;
    };

    export interface MarkerCluster extends Marker {

        /**
        *   Recursively retrive all child markers of this cluster
        */
        getAllChildMarkers(): Marker[];
